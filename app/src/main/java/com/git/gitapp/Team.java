        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.nav_home:
                        Intent i1 = new Intent(Team.this, HomeActivity.class);
                        startActivity(i1);
                        finish();
                    ...
                    case R.id.nav_aboutGit:
                        Intent i2 = new Intent(Team.this, AboutGit.class);
                        startActivity(i2);
                        finish();
                    ...
                    case R.id.nav_department:
                        Intent i3 = new Intent(Team.this, Department.class);
                        startActivity(i3);
                        finish();
                    ...
                    case R.id.nav_circular:
                        Intent i4 = new Intent(Team.this, Circular.class);
                        startActivity(i4);
                        finish();
                    ...
                    case R.id.nav_newsFeed:
                        Intent i5 = new Intent(Team.this, NewsFeed.class);
                        startActivity(i5);
                        finish();
                    ...
                    case R.id.nav_event:
                        Intent i6 = new Intent(Team.this, Events.class);
                        startActivity(i6);
                        finish();
                    ...
                    case R.id.nav_gallery:
                        Intent i7 = new Intent(Team.this, Gallery.class);
                        startActivity(i7);
                        finish();
                    ...
                    case R.id.nav_contactus:
                        Intent i8 = new Intent(Team.this, ConatctusActivity.class);
                        startActivity(i8);
                        finish();
                    ...
                    case R.id.nav_Share:
                        ...
                        Intent I=new Intent(Team.this,LoginActivity.class);
                        startActivity(I);
                        break;
